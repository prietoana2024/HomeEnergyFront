...
//TEXT TAREA PARA COMPONENTE DE CONTRATO
...
//TERMINAN MI COMPONENTES DE LA GRAFICA
...
//componente de acepto 
  ...
  seleccionadoFachadaImg:string='';
  seleccionadoDireccion:string='';
  seleccionadoContacto:string='';
  seleccionadoRazonSocial:string='';
  seleccionadoDetalle:string='';
  ...
  columnasTabla1:string[]=['servicio','cantidad','stock','precio','total','accion'];
  datosDetalleServicios=new MatTableDataSource(this.listaServicios);
  dataSource1=new MatTableDataSource(this.listaServicios)
  ...
  //FORMULARIO REACTIVO COMIENZA
    form = new FormGroup({
      nombre:new FormControl(this.movieListObject[0].nombre,[Validators.required,Validators.minLength(2)]),
      telefono: new FormControl(55855252,Validators.required),
      email: new FormControl('',[Validators.required, Validators.email]),
      direccion: new FormControl(this.movieListObject[0].direccion,Validators.required),
      ...
      url3:new FormControl('GRANDE',Validators.required),
      url4:new FormControl('GRANDE',Validators.required)
    });
    ...
    onSubmit(): void {
      ...
      if(this.form.valid){
        ...
        alert("Rectifique la información suministrada")
      }
    
      
    }
    //FORMULARIO REACTIVO TERMINA 

  constructor(
    private modalActual:MatDialogRef<ModalCotizacionComponent>,
    @Inject(MAT_DIALOG_DATA) public movieListObject:Prospecto,
    private _prospectoServicio:ProspectoService,
    private _utilidadServicio:UtilidadService,
    private dialog: MatDialog,
    private fb:FormBuilder,
    private _formOrden:FormBuilder,
  ...
  ) 
  {
    ...
    this.formOrden=this.fb.group({
      nombre:[this.movieListObject[0].nombre,Validators.required],
      telefono:[,Validators.required],
      email:['',[Validators.required, Validators.email]],
      direccion:[this.movieListObject[0].direccion,Validators.required],
      tipoIdentificacion:['',Validators.required],
      identificacion:[,Validators.required],
      socEin:[,Validators.required],
      tamanoSistema:['',Validators.required],
    ...
    const docDefinition:any= {
      content:[
        ...
        {text: [
          ...
          this.form.value.nombre,'  and  '+'Home Energy.'
        ],margin: [0, 0, 0, 20]},
        ...
        },
        {
          columns: [
            ...
            },
            {
              ...
              width: '50%',
              text:this.form.value.direccion
            }
          ],
          // optional space between columns
          columnGap: 10
        },
        {
          columns: [
            ...
            },
            {
              ...
              width: '50%',
              text:this.form.value.identificacion
            }
          ],
          // optional space between columns
          columnGap: 10
        ...
        },
        {
          columns: [
            ...
            },
            {
              ...
              width: '50%',
              text:this.form.value.tamanoSistema
            }
          ],
          // optional space between columns
          columnGap: 10
        },
        {
          columns: [
            ...
            },
            {
              ...
              width: '50%',
              text:this.form.value.pagoTotal
            }
          ],
          // optional space between columns
          columnGap: 10
        },
        {
          columns: [
            ...
            },
            {
              ...
              width: '50%',
              text:this.form.value.pagoInicial
            }
          ],
          // optional space between columns
          columnGap: 10
        ...
        {image: 'data:image/jpeg,'+ firmaHomeEnergy,
         ...
         { text:this.form.value.notas, fontSize: 14,margin: [0, 0, 0, 20]},
...
//AQUI TERMINA MIS COMPONENTES PARA BEÑ TEXT TAREA


  ngOnInit(): void {
    if(this.movieListObject!=null){
      

      //this.array=Object.entries(this.movieListObject);
      
      //console.log(this.array);

     // let object=Object.fromEntries(this.array);
    // console.log(object);
  ...
  misDatos(){
    ...
    const tarjetas=this.movieListObject;
    console.log(tarjetas);

    this.array=Object.entries(this.movieListObject);
      
    console.log(this.array[5]);
  ...
  seleccionNombre = "Luis"
  modificarValor() {
    this.seleccionNombre = "Otro nombre"
  ...
  for (let i = 0; i < cuotasMensuales.length; i++) {
   ...
   calcularCuotas(){
        ...
        /*  for (let anio = 1; anio <=10; anio++) {
              ...
              const cuotaMensualES = kWh*0.61;

              cuotas.push(cuotaMensualES);
              // Al final de cada año, actualiza la cuota inicial con el incremento anual
              this.valorTotalAnual = this.facturaES+ 1 - this.tasaDescuentoAnual / 100;
          }
          */
      ...
      /*
        console.log("Cada año el valor de su cuota de energia solar se traducirá a pagar mensualmente : "+cuotasES[cuotasES.length - 1]+"  Dolares, incluidos los incrementos anuales");
        console.log("Usted pagará en 10 años alrededor de :" + this.valorTotalAnual);*/


        /*this.cuotasMensualesES=cuotasES[cuotas.length - 1];
        this.cuotasMensualesESTxt=this.totalEE.toString().split('.');
        this.cuotasMensualesESTxt[0]=this.totalEETxt[0].replace(/\B(?=(\d{3})+(?!\d))/g,',');
        this.cuotasMensualesESTxt.join('.');

        this.cuotasMensualesEE=cuotas[cuotas.length - 1];
        this.cuotasMensualesEETxt=this.totalEE.toString().split('.');
        this.cuotasMensualesEETxt[0]=this.totalEETxt[0].replace(/\B(?=(\d{3})+(?!\d))/g,',');
...
/*
    ...
    divLogin(){ 
        if(this.clic==1){
          document.getElementById('textAcepto').setAttribute('readonly','readonly');
          document.getElementById('btnAcepto').setAttribute('background','red');
          console.log("primer click")
          this.clic = this.clic + 1;

        } else{
          document.getElementById('textAcepto').removeAttribute( 'readonly');  
          document.getElementById('textAcepto').setAttribute('contenteditable','true');
      ...
      onchange3(event:any){
        this.url3= event.target.value;
      
      }
      onchange4(event:any){
        this.url4= event.target.value;
